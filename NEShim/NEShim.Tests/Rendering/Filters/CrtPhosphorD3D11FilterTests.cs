...
[TestFixture]
internal class CrtPhosphorD3D11FilterTests
{
    private CrtPhosphorD3D11Filter _filter = null!;

    [SetUp]
    public void SetUp()
    {
        _filter = new CrtPhosphorD3D11Filter();
    }
    ...
    [Test]
    public void PixelShaderResourceName_IsNonNullAndEndsWithCso()
    {
