...
[TestFixture]
internal class MagneticDistortionMotionEffectTests
{
    private MagneticDistortionMotionEffect _effect = null!;

    [SetUp]
    public void SetUp() => _effect = new MagneticDistortionMotionEffect();
    ...
    public void WriteShaderParams_AtFrameZero_PhaseIsZero()
    {
        ...
        Assert.That(buf[0], Is.EqualTo(0f)); // phase = 0 * PhaseRate = 0
    }
