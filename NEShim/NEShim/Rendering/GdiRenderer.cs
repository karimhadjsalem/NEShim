...
/// swap chain presentation to IOverlayRenderer. Used when D3D11 initialisation fails.
/// Does not own GamePanel or IOverlayRenderer.
/// </summary>
...
internal sealed class GdiRenderer : IFrameRenderer
{
    ...
    internal GdiRenderer(GamePanel gamePanel, IOverlayRenderer overlayRenderer)
    {
    ...
    public void Tick(bool vsync)              => _overlayRenderer.Present();
    public void Resize(int width, int height) => _overlayRenderer.Resize(width, height);
